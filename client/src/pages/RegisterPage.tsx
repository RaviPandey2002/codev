      ...
      <main className="w-full max-w-md mx-auto px-6 my-auto z-10">
        <div className="bg-card/75 backdrop-blur-xl border border-border/60 shadow-2xl shadow-black/10 dark:shadow-black/40 rounded-2xl p-7 sm:p-9 space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-left">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <UserIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none" size={15} />
                <Input
                  id="username"
                  type="text"
                  placeholder="johndoe"
              ...
              {errors.username && (
                <p className="text-[11px] text-destructive font-medium mt-1">{errors.username.message}</p>
              )}
            </div>
          ...
          <div className="pt-2 text-center text-xs text-muted-foreground border-t border-border/40">
            ...
            <Link to="/login" className="text-foreground font-semibold hover:text-primary transition-colors underline-offset-4 hover:underline">
              Sign in instead
            </Link>
          </div>
        </div>
